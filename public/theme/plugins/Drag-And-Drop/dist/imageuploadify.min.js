...
(function($, window, document, undefined) {
	...
	$.fn.imageuploadify = function(opts) {
		...
		this.each(function() {
			...
			let name_input_id = this.id ;
				console.log(name_input_id);

			let text_name_input = check_File(name_input_id) ;
			...
			let dragbox = $(`
				<div class="imageuploadify well">
					...
					<div class="imageuploadify-images-list text-center">
						...
						<button type="button"class="btn btn-default" style="width:75%;">
			...
			const readingFile = (id, file) => {
				...
				deleteBtn.on("click", function() {
				    ...
				    // แสดงจำนวนไฟล์ทั้งหมดหลังจากลบไฟล์
			    	console.log(name_input_id);
				    console.log(name_input_id + " จำนวนไฟล์ทั้งหมด: " + totalFiles.length);
			...
			$(self).on("change", function onChange() {
			    ...
			    // แสดงจำนวนไฟล์ทั้งหมดหลังจากเพิ่มไฟล์
			    console.log(name_input_id);
			    console.log(name_input_id + " จำนวนไฟล์ทั้งหมด: " + totalFiles.length);
				console.log(totalFiles);
...
function check_File(name_input) {
    ...
    return text_name_input + " (สูงสุด "+maxFileCount+" ไฟล์)" ;
