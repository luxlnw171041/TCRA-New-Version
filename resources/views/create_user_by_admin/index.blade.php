...
<style>
    ...
    * {
    ...
    .td_member_co {
        width: 250px;
        height: 1em;
        /* กำหนดความสูงของ td เพื่อให้ทำงานกับ ellipsis */
        white-space: nowrap;
        overflow: hidden;
...
<div class="row">
    ...
    <style>
        ...
        @media (min-width: 768px) and (max-width: 1204px){
            .col-create-user ,.col-data-user{
                flex: 0 0 auto !important;
	            width: 100% !important;
            }
        }
        @media (min-width: 1205px) and (max-width: 1664px){
            .col-create-user {
                flex: 0 0 auto !important;
	            width: 40% !important;
            } .col-data-user{
    ...
    <div class="col-md-3 col-create-user">
        <div class="sticky">
            <div>
    ...
    <div class="col-md-9 col-data-user">
