                ...
                <div class="row">
                        ...
                        <div class="card-body col-md-6 d-flex align-items-center ">
                            <div class="col-md-12">
                                ...
                                <h1 style="font-family: 'Prompt', sans-serif;text-shadow: 2px 2px 2px rgba(150, 150, 150, 1);margin-top:25px;"> <b>Blacklist system, <span style="color: #0f72ac;">TCRA</span></b> </h1>
